...
const AddRoom = () => {
  ...
  return (
    <form>
        <Title align='left' font='sans' title='Add Room' subTitle='Fill in the details carefully and accurate room details, pricing, and amenities, to enhance the user booking experience.'/>
        {/* Upload area for imgaes */}
          <p className='text-gray-800 mt-10'>Images</p>
          <div className='grid grid-cols-2 gap-4 my-2 sm:flex'>
          ...
          <p className='text-gray-800 mt-4'>Aemnities</p>
