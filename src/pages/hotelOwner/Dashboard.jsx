...
const Dashboard = () => {
      ...
      return (
    <div>
        <Title align='left' font='sans' title='DashBoard' subTitle='Moniter your room listings, track bookings and analyze revenue-all in one place. Stay updated with real time insights to ensure smooth operations.' />
        ...
        <div className='flex gap-4 my-8'>
             ...
             {/* Total revenune */}
             <div className='bg-blue-500/3 border border-blue-500/10 rounded flex p-4 pr-8'>
                   <img src={assets.totalRevenueIcon} alt="" className='max-sm:hidden h-6.5 text-blue-500' />
                   <div className='flex flex-col sm:ml-4 font-medium'>
